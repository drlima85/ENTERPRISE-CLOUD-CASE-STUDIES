...
> Conjunto de dois runbooks em PowerShell (Azure Automation), responsáveis por detectar e corrigir desvios, e dois Logic Apps, responsáveis por **entregar essa informação por e-mail** aos responsáveis em cada etapa — construído com apoio do GitHub Copilot.
